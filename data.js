/**
 * Reva Trips - Default Database & Configuration
 */
window.REVA_DEFAULT_DATA = {
  settings: {
    ...
    heroTitleAr: 'إقامتك المثالية في دهب وسيناء بلمسة واحدة',
  ...
  hotels: [
    {
      ...
      rating: 4.9,
      amenities: ['واي فاي سريع', 'حمام سباحة', 'شاطئ خاص', 'تكييف', 'مطعم بدوي'],
      rooms: [
        {
          id: 'room_1',
    ...
    },
    {
      ...
      rating: 5.0,
      amenities: ['شاطئ خاص', 'إفطار بوفيه مفتوح', 'واي فاي عالي السرعة', 'سبا وجاكوزي'],
      rooms: [
        {
          id: 'room_3',
    ...
    },
    {
      ...
      rating: 4.8,
      amenities: ['شاطئ رملي خاص', 'أكواخ مكيفة', 'مطعم سيناوي', 'سهرات نار شاطئية'],
      rooms: [
        {
          id: 'room_4',
    ...
    },
    {
      ...
      rating: 4.9,
      amenities: ['3 أحواض سباحة', 'أكوا بارك', 'شاطئ خاص بالمرجان', 'شامل كلياً (All-Inclusive)'],
      rooms: [
        {
          id: 'room_5',
